        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2 text-sm text-slate-500">
                    ...
                    <span class="font-medium text-slate-800">Delivery Classification Report</span>
                </div>
            </div>
        </nav>
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            <h1 class="text-3xl font-bold tracking-tight text-slate-900 mb-2">
                                Delivery Classification Report
                            </h1>
                        </div>
    ...
    <script type="text/javascript">
      $(function () {
        ...
        $('#report_type_filter').change(function(){
            ...
            var newUrl = "{{ route('reports.delivery_classification') }}?type=" + type;
